...
public class RowToObjectTest {
	...
	@Test(expected = IllegalArgumentException.class)
	public void test_getValueAsObject_no_value_no_class() throws Exception {

		String column = "id";
		String defaultValue = "default value";
		List<String> myRow = Lists.newArrayList("content");
		Map<String, Integer> myHeaders = Maps.newHashMap();
		myHeaders.put("text", 0);

		Map<String, Class> columnNamesAndTypes = Maps.newHashMap();

		RowToObject rowToObject = new InnerRowToObject(myHeaders, myRow, null);
		rowToObject.getValueAsObject(myRow, column, myHeaders, defaultValue, columnNamesAndTypes);
	}

	@Test
	public void test_getValueAsObject_no_value_has_class() throws Exception {
		...
		Map<String, Class> columnNamesAndTypes = Maps.newHashMap();
		columnNamesAndTypes.put("id", String.class);

		RowToObject rowToObject = new InnerRowToObject(myHeaders, myRow, null);
		Object valueAsObject = rowToObject.getValueAsObject(myRow, column, myHeaders, defaultValue, columnNamesAndTypes);
		//
		assertThat(valueAsObject, is(instanceOf(String.class)));
		assertThat((String) valueAsObject, is(defaultValue));
	}

	@Test
	public void test_getValueAsObject_has_value_has_class() throws Exception {
		String column = "id";
		String defaultValue = "default value";
		List<String> myRow = Lists.newArrayList("content", "154");
		Map<String, Integer> myHeaders = Maps.newHashMap();
		myHeaders.put("text", 0);
		myHeaders.put("id", 1);
		...
		//
		assertThat(valueAsObject, is(instanceOf(String.class)));
		assertThat((String) valueAsObject, is("154"));
	}

	@Test
	public void test_getValueAsObject_has_value_has_class_integer() throws Exception {
		String column = "id";
		String defaultValue = "default value";
		List<String> myRow = Lists.newArrayList("content", "154");
		Map<String, Integer> myHeaders = Maps.newHashMap();
		...
		Map<String, Class> columnNamesAndTypes = Maps.newHashMap();
		columnNamesAndTypes.put("id", Integer.class);

		RowToObject rowToObject = new InnerRowToObject(myHeaders, myRow, null);
		Object valueAsObject = rowToObject.getValueAsObject(myRow, column, myHeaders, defaultValue, columnNamesAndTypes);
		//
		assertThat(valueAsObject, is(instanceOf(Integer.class)));
		assertThat((Integer) valueAsObject, is(154));
	}

	@Test(expected = IllegalArgumentException.class)
	public void test_getValueAsObject_has_value_has_class_integer_bad_value() throws Exception {
		String column = "id";
		String defaultValue = "default value";
		List<String> myRow = Lists.newArrayList("content", "id");
		Map<String, Integer> myHeaders = Maps.newHashMap();
		myHeaders.put("text", 0);
		myHeaders.put("id", 1);
	...
	@Test(expected = IllegalArgumentException.class)
	public void test_getValueAsObject_has_value_has_class_invalid() throws Exception {
		String column = "id";
		String defaultValue = "default value";
		List<String> myRow = Lists.newArrayList("content", "id");
		Map<String, Integer> myHeaders = Maps.newHashMap();
		...
		Map<String, Class> columnNamesAndTypes = Maps.newHashMap();
		columnNamesAndTypes.put("id", RowToObject.class);
	...
	@Test(expected = IllegalArgumentException.class)
	public void test_getValueAsObject_has_value_has_class_but_is_interface() throws Exception {
		String column = "id";
		String defaultValue = "default value";
		List<String> myRow = Lists.newArrayList("content", "id");
		Map<String, Integer> myHeaders = Maps.newHashMap();
		...
		Map<String, Class> columnNamesAndTypes = Maps.newHashMap();
		columnNamesAndTypes.put("id", Serializable.class);
	...
	@Test(expected = IllegalArgumentException.class)
	public void test_getValueAsObject_has_value_has_class_but_has_no_constructor() throws Exception {
		String column = "id";
		String defaultValue = "default value";
		List<String> myRow = Lists.newArrayList("content", "id");
		Map<String, Integer> myHeaders = Maps.newHashMap();
		...
		Map<String, Class> columnNamesAndTypes = Maps.newHashMap();
		columnNamesAndTypes.put("id", Calendar.class);
